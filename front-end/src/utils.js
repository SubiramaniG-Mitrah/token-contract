...
const provider = new ethers.JsonRpcProvider(`https://goerli.infura.io/v3/`);
...
export const tokenContract = new ethers.Contract(tokenContractAddress, tokenContractABI);
